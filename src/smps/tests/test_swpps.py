...
from smps.features.engineering import FeatureEngineer, FeatureConfig
from smps.ml.hybrid_model import ResidualLearner, HybridModelConfig
from smps.validation.metrics import compute_kge, compute_nse
...
class TestFeatureEngineeringConversions:
    def test_feature_engineer_uses_vg_params_for_conversions(self):
        ...
        assert np.allclose(theta_actual.values, theta_expected.values, atol=1e-10)
...
class TestPsiDrivenETStress:
    ...
    def test_no_stress_above_field_capacity(self):
        ...
        from smps.physics.evapotranspiration import compute_water_stress_from_potential
...
class TestResidualDiagnostics:
    ...
    def test_detect_dry_bias(self):
        ...
        from smps.calibration.calibrate import ResidualAnalyzer
...
class TestThetaOutputConversion:
    ...
    def test_physics_output_theta_conversion(self):
        ...
        from smps.core.types import PhysicsModelOutput
        from smps.physics.van_genuchten import VanGenuchtenParams as VGParams
    ...
    def test_prediction_result_theta_conversion(self):
        ...
        from smps.core.types import PredictionResult, SoilMoistureStatus
