...
class PhysicsModelOutput:
    ...
    # Optional layer-wise outputs for advanced physics + ML features
    theta_layers: Optional[List[float]] = None
    psi_layers: Optional[List[float]] = None
    lambda_layers: Optional[List[float]] = None
