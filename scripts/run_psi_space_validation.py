    ...
    def run_validation(self, max_stations: Optional[int] = None,
        ...
        for split_name, split_df in [
            ...
            for horizon in horizons:
                ...
                physics_psi = valid_df['physics_prior_surface'].values
                ...
                psi_metrics = evaluate_psi_space_metrics(
                    valid_df['observed_psi'].values, predicted_psi
                )
                ...
                theta_metrics = self._compute_theta_metrics(
                    valid_df['soil_moisture'].values, predicted_theta.values
                )
                ...
                pd.DataFrame({
                    ...
                    'observed_psi': valid_df['observed_psi'].values,
